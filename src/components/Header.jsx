          ...
          <MenuItem className="p-0 hover:bg-transparent">
            ...
            >
              ...
              <div className="flex flex-col text-sm">
                <span className="text-sm">Joseph Vega</span>
                <span className="text-xs text-gray-500">josephvtx@domain.com</span>
              </div>
            </Link>
          </MenuItem>
